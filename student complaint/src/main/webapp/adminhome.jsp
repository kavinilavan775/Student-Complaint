...
<hr>
<center><h1>Welcome to admin home.....</h1></center><hr><br><br>
<br>
<a href="studentlist.jsp">
<button type="submit" class="registerbtn" style="width:100%;">Student List</button></a><br> 
<form action="onprocess.jsp" method="post">
...
try
{
	...
	<tr>	
					...
					<td name="n5"><img src="<%=rs.getString(3) %>" width="80px" height="80px" ></td>
					
    <td><div class="container">
    <center><a href="deletestudent.jsp"> <button class="process-button">DELETE</button><br></a><center></div>
